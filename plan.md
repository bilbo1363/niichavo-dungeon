...
**Файлы:** `systems/stats.py`, `systems/level_system.py`, `systems/modifiers.py`
...
- ⏳ UI характеристик (осталось)

---

### 0.2 Способности и умения ⭐⭐⭐ (Неделя 2)
**Статус:** ⏳ Ожидание  
**Файлы:** `systems/abilities.py`, `data/abilities.json`, `ui/ability_tree_screen.py`
...
**Общий прогресс v0.4.0:** 8% (0.8/10 систем)

**Этап 0: Фундамент**
- [x] Характеристики и прогрессия (80%) ← В ПРОЦЕССЕ
- [ ] Способности и умения (0%)
