...
**Следующее:**
- Создать базовую структуру способностей
- Реализовать дерево зависимостей
- Интеграция с системой модификаторов
...
**Общий прогресс v0.4.0:** 10% (1/10 систем)

**Этап 0: Фундамент**
- [x] Характеристики и прогрессия (100%) ✅ ЗАВЕРШЕНО
- [ ] Способности и умения (0%) ← СЛЕДУЮЩЕЕ
