...
### Основная идея:
Подземелье - это **экспериментальные лаборатории и хранилища НИИЧАВО**, которые были заброшены или вышли из-под контроля. Игрок исследует результаты магических экспериментов.
