...
class Game:
    ...
    def __init__(self, width: int = 1200, height: int = 800, fullscreen: bool = False):
        ...
        self.sound_manager.start_music("splash")
    ...
    def run(self) -> None:
        ...
        # Музыка заставки уже запущена в __init__
        # Музыка меню запустится после заставки
        # Музыка игры запустится при старте профиля
        ...
        while self.running:
            ...
            if self.show_splash:
                ...
                if self.splash_screen.update(dt):
                    ...
                    self.sound_manager.start_music("menu")
    ...
    def _start_game_with_profile(self, profile_name: str) -> None:
        ...
        self.sound_manager.stop_music()
        self.sound_manager.start_music(self.current_location)
